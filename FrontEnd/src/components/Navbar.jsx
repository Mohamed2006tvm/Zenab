            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to={user ? '/dashboard' : '/'} className="flex items-center gap-2">
                        ...
                        <span className="text-white font-bold text-xl tracking-tight">Zenab</span>
                    </Link>
                    ...
                    <div className="flex items-center gap-3">
                        {user ? (
                                        ...
                                        <div className="absolute right-0 mt-2 w-56 bg-[#111827] border border-slate-700 rounded-xl shadow-2xl shadow-black/50 overflow-hidden z-50">
                                            ...
                                            <div className="py-1">
                                                <Link
                                                    ...
                                                    className="flex items-center gap-3 px-4 py-2.5 text-slate-300 hover:text-white hover:bg-slate-800 transition-colors text-sm"
                                                >
                            ...
                            <div className="flex items-center gap-2">
                                <Link to="/auth/login" className="px-4 py-1.5 text-sm text-slate-300 hover:text-white transition-colors">
                                    Sign In
                                </Link>
                                <Link
                                    to="/auth/signup"
                                    className="px-4 py-1.5 text-sm bg-emerald-500 hover:bg-emerald-400 text-white rounded-md font-medium transition-colors"
                                >
                                    Get Started
                                </Link>
                            </div>
                    ...
                    <div className="md:hidden border-t border-slate-800 py-3">
                        {navLinks.map((link) => (
                            <Link
                                ...
                                className={`block px-3 py-2 rounded-md text-sm font-medium mb-1 transition-colors ${location.pathname === link.to
                                    ? 'bg-emerald-500/20 text-emerald-400'
                                    : 'text-slate-400 hover:text-white hover:bg-slate-800'
                                    }`}
                            >
                        ...
                        <Link
                            to="/profile"
                            onClick={() => setMenuOpen(false)}
                            className="block px-3 py-2 rounded-md text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 transition-colors"
                        >
                            Edit Profile
                        </Link>
                    </div>
