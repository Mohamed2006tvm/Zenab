...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Append the generated ID to the user's full name to store it
            const nameWithId = `${form.fullName} (ID: ${zenabId})`;
            await signUp(form.email, form.password, nameWithId);

            // Alert the user so they see their new Analysis ID
            window.alert(`Registration successful!\n\nYour Unique Analysis ID is: ${zenabId}\n\nPlease save this ID, you will use it for your analysis.`);
            navigate('/analyze');
        } catch (err) {
